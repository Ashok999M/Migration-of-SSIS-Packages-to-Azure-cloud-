...
CREATE PROCEDURE [dbo].[usp_SSIS_ScriptEnvironmentReference]
          @folder sysname
AS
        SET NOCOUNT ON;
        ...
        INTO #cmd
        from [internal].[environment_references] enr 
		INNER JOIN [internal].[projects] prj ON enr.project_id=prj.project_id
		INNER JOIN [internal].[folders] fol ON prj.folder_id=fol.folder_id  
