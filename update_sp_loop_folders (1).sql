...
BEGIN
	...
	BEGIN
		...
		INSERT INTO #temp_folder_env (Folder, Environment) SELECT fol.name, env.environment_name FROM internal.environments env JOIN internal.folders fol ON env.folder_id=fol.folder_id
	...
	BEGIN
		...
		INSERT INTO #temp_folder_env2 (Folder) SELECT fol.name FROM internal.folders fol
	...
	BEGIN
		...
		INSERT INTO #temp_folder_env3 (Folder) SELECT fol.name FROM internal.folders fol
